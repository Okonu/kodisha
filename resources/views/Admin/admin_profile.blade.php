                ...
                <div class="nav">
                    <ul>
                        <li class="nav-settings">
                            @php
                            $count = \App\RegisterAgent::all()->where('is_recived','=',1)->where('is_upgraded','=',0)->count();
                            @endphp
                ...
                <div class="modal-content card card-image" style="background-image: url('img/login.jpg');">
                    <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
                        ...
                        <div class="modal-header text-center pb-4">
                            <h3 class="modal-title w-100 white-text font-weight-bold" id="myModalLabel"><strong>Update</strong> <a class="green-text font-weight-bold"><strong> Admin Profile</strong></a></h3>
